...
export default function Education() {
  ...
  return (
    <section className="min-h-screen bg-black text-white py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
      {/* Heading */}
      <motion.h2
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      {/* Timeline */}
      <div className="relative border-l-4 border-green-600 pl-4 sm:pl-6 max-w-3xl sm:max-w-4xl mx-auto space-y-8 sm:space-y-12">
        {education.map((edu, i) => (
          <motion.div
            key={i}
            initial={{ opacity: 0, x: -50 }}
